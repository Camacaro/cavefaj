    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <a href="{{ url('/admin/feria/create') }}" class="btn btn-box-tool" data-toggle="tooltip" title="Nuevo"><i class="fa fa-plus"></i></a>
            ...
            'columns': [
                ...
                {data: 'created_at', className:"text-center"},
                {
                    render: function (data, type, row) {
                        ...
                        var ruta_edit = "{{url('/admin/feria/')}}/" + row.id + "/edit";
